...
<div class="form-group">
          ...
          <div class="col-lg-8">
            <div class="bs-component">
              <input type="text" id="" name="uri" class="form-control" placeholder="" value="{{$data->uri}}" readonly />
            </div>
          </div>
        </div>
...
<div class="sid_bvijay mb10">
   ...
   <div class="hd_show_con">
    <div class=" mb15">
     <div class="form-group">
       <select name="mobile_menu" class="form-control input-sm">
        <option value="0" {{($data->mobile_menu == 0)?"selected":""}}> No </option> 
        <option value="1" {{($data->mobile_menu == 1)?"selected":""}}> Yes </option>    
      </select>
    </div>
  </div>
</div>
