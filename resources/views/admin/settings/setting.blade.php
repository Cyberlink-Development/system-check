            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="site_name" class="form-control"
                                    placeholder="" value="{{ $data->site_name }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="address" class="form-control" placeholder=""
                                    value="{{ $data->address }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-3 control-label">Phone (ad)</label>
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="phone2" class="form-control" placeholder=""
                                    value="{{ $data->phone2 }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-3 control-label">Primary Email</label>
                        <div class="col-lg-6">
                            <div class="bs-component">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="email4" class="form-control" placeholder=""
                                    value="{{ $data->email4 }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="email3" class="form-control"
                                    placeholder="" value="{{ $data->email3 }}" />
                            </div>
                        </div>
                    </div>
                    <?php */?>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="reg_number" class="form-control"
                                    placeholder="" value="{{ $data->reg_number }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-3 control-label"> Youtube Link</label>
                        <div class="col-lg-6">
                            <div class="bs-component">
                                <input type="text" id="inputStandard" name="youtube_link" class="form-control"
                                    placeholder="" value="{{ $data->youtube_link }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputStandard" class="col-lg-3 control-label" for="textArea3">Meta
                            Description</label>
                        <div class="col-lg-6">
                            <div class="bs-component">
