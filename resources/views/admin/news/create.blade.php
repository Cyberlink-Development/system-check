                ...
                <form class="form-horizontal" action="{{ route('news.store', Request::segment(3) ) }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="panel-group accordion" id="accordion">
                    <div class="_form-group panel bs-component">
                      <input type="text" class="form-control" name="news_title" placeholder="News Title (Required*)" value="{{ old('news_title') }}" />
                    </div>
                   ...
                   <div class="_form-group panel">                
                     <div class="panel">
                      <div class="panel-body pn of-h" >
                       <textarea class="testEditor" name="news_content" style="width: 100%;" rows="30"> {{ old('news_content') }} </textarea>
                     </div>
                   </div>
                 </div>
                 <!--  -->
           ...
           <?php */?>     
               ...
               <div class="panel-group accordion" id="accordion">
                ...
                <div id="accord_1" class="panel-collapse collapse in" aria-expanded="true">
                  ...
                  <div class="panel-body">
                    <input type="text" name="news_video" class="form-control" value="{{ old('news_video') }}" />                  
                 </div>
               </div>
             </div>
           </div>
...
<div class="sid_bvijay mb10">
   <h4> Choose Date<span style="color: red">*</span></h4>
  <input type="text" class="form-control" id="date-picker" name="nepali_date" placeholder="२०७८ बैशाख १" value="{{ old('nepali_date') }}"  readonly>
   ...
   <ul class="ctgor">
    <li>
     <label class="option">
       ...
       <span class="checkbox"></span>Headline News</label>
     </li>
...
<div class="sid_bvijay mb10">
 <h4> News Type/Categories<span style="color: red">*</span> </h4>
 <div class="hd_show_con">
...
<!-- <div class="sid_bvijay mb10">
<input type="text" class="form-control" name="author" value="{{ old('author') }}" placeholder="पत्रकारको नाम " />
</div> -->

@if($content_writers->count() > 0)
<div class="sid_bvijay mb10">
 <h4> Post By<span style="color: red">*</span></h4>
 <div class="hd_show_con">
  <div class=" mb15">
   <div class="form-group">
...
<div class="sid_bvijay mb10">
 ...
 <div> <input type="text" name="thumbnail_caption" class="form-control" placeholder="thumbnail caption" /></div>
</div>
</div>
