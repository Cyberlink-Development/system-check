    ...
    <section id="content">
        ...
        <div class="col-lg-9">
            <h3 style="text-left"> Edit News &nbsp;
                ...
                <a href="{{ url(get_newstype($data->news_type)['uri'] . '/' . splitTimeStamp($data->created_at, $data->uri)) }}"
                    target="_blank"> Visit Post</a>
            </h3>
            <form class="form-horizontal" action="{{ url('admin/type/' . Request::segment(3), $data->id) }}" method="post"
                    ...
                    <div class="_form-group panel">
                        <div class="panel">
                            <div class="panel-body pn of-h">
                                <textarea class="testEditor" name="news_content" style="width: 100%;" rows="30">
                         {{ $data->news_content }}
                       </textarea>
                            </div>
                        </div>
                    ...
                    <div class="panel">
                        ...
                        <div id="accord1" class="panel-collapse collapse in" name="news_excerpt" aria-expanded="true">
                            <div class="panel-body">
                                <textarea class="form-control" name="news_excerpt" rows="3">{{ $data->news_excerpt }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-group accordion" id="accordion">
                    <div class="panel">
                        <div class="panel-heading">
                            <a class="accordion-toggle accordion-icon link-unstyled" data-toggle="collapse"
                                data-parent="#accordion" href="#accord3" aria-expanded="true">
                                Custom Link
                            </a>
                        </div>
                ...
                <div class="panel-group accordion" id="accordion">
                    <div class="panel">
                        <div class="panel-heading">
                            <a class="accordion-toggle accordion-icon link-unstyled" data-toggle="collapse"
                                data-parent="#accordion" href="#accord_1" aria-expanded="true">
                                News Video ID
                            </a>
                        </div>
                        <div id="accord_1" class="panel-collapse collapse in" aria-expanded="true">
                            ...
                            <div class="panel-body">
                                <input type="text" name="news_video" class="form-control"
                                    value="{{ $data->news_video }}" />
            ...
            <div class="admin-form">
                ...
                <div class="sid_bvijay mb10">
                    <input type="text" class="form-control" id="date-picker" name="nepali_date"
                        value="{{ $data->nepali_date }}" placeholder="२०७८ बैशाख १" readonly>
                    <!--
        ...
        <select class="form-control" name="minute">
         ...
         <option value="४८" {{ $data->minute == '४८' ? 'selected' : '' }}४८</option>
         ...
         <div class="form-group">
           <select name="video_status" class="form-control input-sm">
            <option value="0" {{ $data->video_status == 0 ? 'selected' : '' }}> Default </option>
            <option value="1" {{ $data->video_status == 1 ? 'selected' : '' }}> Standard </option>
          </select>
        </div>
        </div>
        </div>
         -->
                                ...
                                <li>
                                    <div class="bs-component">
                                        <div class="radio-custom mb5">
                                            ...
                                            <label for="radioExample4">Breaking News</label>
                                        </div>
                                    </div>
                                </li>
                                <!--
            <li>
               ...
               <div class="bs-component">
                <div class="radio-custom mb5">
                  <input type="radio" id="radioExample5" name="is_specialnews" value="2" {{ $data->is_specialnews == 2 ? 'checked' : '' }} />
                  <label for="radioExample5">Heading News</label>
                </div>
              </div>
                                            ...
                                            <li>
                                                <label class="option">
                                                    <input type="checkbox" name="news_type[]"
                                                        value="{{ $row->id }}"
                                                        {{ in_array($row->id, $check_newstype) ? 'checked' : '' }} />
                ...
                <!-- <div class="sid_bvijay mb10">
        <input type="text" class="form-control" name="author" value="{{ $data->author }}" placeholder="पत्रकारको नाम " />
        </div> -->
                                ...
                                <div class="form-group">
                                    <select name="content_writer" class="form-control input-sm">
                                        ...
                                        @foreach ($content_writers as $row)
                                            <option value="{{ $row->id }}"
                                                {{ $row->id == $data->content_writer ? 'selected' : '' }}>
                ...
                <div class="sid_bvijay mb10">
                    ...
                    <div class="hd_show_con">
                        ...
                        <input type="checkbox" name="thumbnail_status" value="1"
                            {{ $data->thumbnail_status ? 'checked' : '' }} /> Hide from detail
                        ...
                        <div> <input type="text" name="thumbnail_caption" class="form-control"
                                value="{{ $data->thumbnail_caption }}" placeholder="thumbnail caption" /></div>
                    </div>
                </div>
