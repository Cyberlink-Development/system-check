...
// Auth::routes();
// Route::get('rssfeed', 'RssFeedController@feed');
...
Route::get('page/{newstype}', 'FrontendControllers\FrontpageController@newstype')->name('news.newstype');
//Route::get('{newstype}/{newscategory}','FrontendControllers\FrontpageController@newscategory')->name('news.newscategory');
Route::get('{newstype}/{year}/{month}/{day}/{uri}.html', 'FrontendControllers\FrontpageController@newsdetail')->name('news.newsdetail');
...
//profile
Route::get('profile/{uri}.html', 'FrontendControllers\FrontpageController@profile')->name('page.profile');
...
Route::middleware(['auth'])->group(function () {
	...
	Route::resources([
		...
		'admin/teamcategory' => 'AdminControllers\News\teamcategoryController',
	...
	Route::get('admin/teamcategory/{id}/delete', 'AdminControllers\News\teamcategoryController@destroy');
	...
	//
	Route::get('admin/headlines', 'AdminControllers\News\NewsController@headlines')->name('news.headlines');
	Route::get('admin/breaking-news', 'AdminControllers\News\NewsController@breaking_news')->name('news.breaking-news');
});
