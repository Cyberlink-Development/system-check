...
class NewsController extends Controller
{
    ...
    return view('admin.news.create', compact('newtype','category','templates','content_writers','_ordering'));
}
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasfile('news_thumbnail')){
            ...
            $thumb_picture->save($destinationOriginal .'/'. $thumb_name ); 
    ...
    return view('admin.news.edit', compact('data','newtype','category','content_writers' ,'_newstype','_newscategory','check_newstype'));
}
    ...
    {  
        ...
        $data->news_content = \Mews\Purifier\Facades\Purifier::clean($request->news_content);
    ...
    public function news_list($newstype){
        ...
        // $data = NewsTypeModel::find($newstype_id)->news()->orderBy('ordering','desc')->paginate(710);
